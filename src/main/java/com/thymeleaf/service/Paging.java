...
public class Paging {
	...
	public void setPagingHtml() {
		...
		if (prev) {
			if (rest)
				sb.append("<li class=\"page-item\"><a class=\"page-link\" href=\"" + link + prevStartPage
						+ "\">Prev</a></li>");
			else
				sb.append("<li class=\"page-item\"><a class=\"page-link\" href=\"" + link + queryStr + "page="
						+ prevStartPage + "\">Prev</a></li>");
		} else {
		...
		for (int i = startPage; i <= endPage; i++) {
			if (rest) {
				if (page == i)
					sb.append("<li class=\"page-item active\"><a class=\"page-link\" href=\"" + link + i + "\">" + i
							+ "</a></li>");
				else
					sb.append("<li class=\"page-item\"><a class=\"page-link\" href=\"" + link + i + "\">" + i
							+ "</a></li>");
			} else {
				if (page == i)
					sb.append("<li class=\"page-item active\"><a class=\"page-link\" href=\"" + link + queryStr
							+ "page=" + i + "\">" + i + "</a></li>");
				else
					sb.append("<li class=\"page-item\"><a class=\"page-link\" href=\"" + link + queryStr + "page=" + i
							+ "\">" + i + "</a></li>");
			}
		}
		...
		if (next) {
			if (rest)
				sb.append("<li class=\"page-item\"><a class=\"page-link\" href=\"" + link + nextStartPage
						+ "\">Next</a></li>");
			else
				sb.append("<li class=\"page-item\"><a class=\"page-link\" href=\"" + link + queryStr + "page="
						+ nextStartPage + "\">Next</a></li>");
		} else {
	...
	public String toString() {
		return "Paging [rest=" + rest + ", viewCnt=" + viewCnt + ", pageViewCnt=" + pageViewCnt + ", totalCnt="
				+ totalCnt + ", pageTotalCnt=" + pageTotalCnt + ", pageGroupToltalCnt=" + pageGroupToltalCnt + ", page="
				+ page + ", startPage=" + startPage + ", endPage=" + endPage + ", startRow=" + startRow + ", endRow="
				+ endRow + ", pageGroup=" + pageGroup + ", link=" + link + ", pageHtml=" + pageHtml + ", prev=" + prev
				+ ", next=" + next + "]";
	}
